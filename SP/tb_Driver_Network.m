function tb_Driver_Network()
    res_dir = '/home/michael/simulation/tb_Driver_Network/spectre/config/psf';
    close all     
    ...
    title(['Driver Network Return Loss S11'],'interpreter', 'none' )
    print(gcf,'-dpng',[ 'DriverNetworkReturnLossS12.png']);
    print(gcf,'-depsc2',[ 'DriverNetworkReturnLossS12.eps']);
    ...
    ylabel('S Parameter (dB20)')       
    legend({'SP_{EM,calibreCCC}','SP_{design}'})
    title(['Driver Network Return Loss S22'],'interpreter', 'none' )
    print(gcf,'-dpng',[ 'DriverNetworkReturnLossS21.png']);
    print(gcf,'-depsc2',[ 'DriverNetworkReturnLossS21.eps']);
    ...
    ylabel('S Parameter (dB20)')       
    legend({'SP_{EM,calibreCCC}','SP_{design}'})
    title(['Driver Network Insertion Loss S12'],'interpreter', 'none' )
    print(gcf,'-dpng',[ 'DriverNetworkInsertionLossS12.png']);
    print(gcf,'-depsc2',[ 'DriverNetworkInsertionLossS12.eps']);
    ...
    ylabel('S Parameter (dB20)')       
    legend({'SP_{EM,calibreCCC}','SP_{design}'})
    title(['Driver Network Insertion Loss S21'],'interpreter', 'none' )
    print(gcf,'-dpng',[ 'DriverNetworkInsertionLossS21.png']);
    print(gcf,'-depsc2',[ 'DriverNetworkInsertionLossS21.eps']);
